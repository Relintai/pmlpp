...
class MLPPActivationOld : public Reference {
	GDCLASS(MLPPActivationOld, Reference);
...
public:
	typedef real_t (MLPPActivationOld::*RealActivationFunctionPointer)(real_t);
	typedef Ref<MLPPVector> (MLPPActivationOld::*VectorActivationFunctionPointer)(const Ref<MLPPVector> &);
	typedef Ref<MLPPMatrix> (MLPPActivationOld::*MatrixActivationFunctionPointer)(const Ref<MLPPMatrix> &);
